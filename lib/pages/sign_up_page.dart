      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SvgPicture.asset("assets/icons/ic_arrow_back.svg"),
                ...
                children: [
                  ...
                  GestureDetector( onTap: ( ){
                    Navigator.of(context).pushNamed(LoginPage.id);
                      ...
                      child: Text("Sign in",style: TextStyle(color: AppColors.colorMain,fontWeight: FontWeight.w700, fontFamily: "Montserrat",fontSize: 16),)),
                ],
              )
